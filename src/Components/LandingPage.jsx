...
import backgroundImg from "../Components/background.jpg"; // Import Background Image
import { motion } from "framer-motion";

const LandingPage = ({ onEnter }) => {
  return (
    <div 
      className="flex flex-col items-center justify-center h-screen text-white relative bg-cover bg-center"
      style={{ backgroundImage: `url(${backgroundImg})`, backgroundSize: "cover", backgroundPosition: "center" }}
    >
      <div className="absolute inset-0 bg-black bg-opacity-50"></div> {/* Dark Overlay for Better Visibility */}
      
      <motion.img 
        src={profilePic} 
        alt="Saugnik Aich" 
        className="w-48 h-48 rounded-full mb-6 border-4 border-blue-500 shadow-xl relative z-10"
